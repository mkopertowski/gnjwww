...
//	example		text: ['<b>P</b>rev','<b>N</b>ext','<b>C</b>lose'],
				...
				resizeTransition: true,		// Mootools transition effect (false leaves it at the default)
				...
				counterText: '({x} z {y})',	// Translate or change as you wish
//			Image options
				imgBackground: true,		// Embed images as CSS background (true) or <img> tag (false)
...
//			NonverBlaster
				...
				playerpath: '../_js/NonverBlaster.swf',	// Path to NonverBlaster.swf
