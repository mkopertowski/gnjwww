...
EndList();
*/
NewSection('GRUDZIEŃ 2006','section');
StartList();

  ExtendedListItem('Rekonesans za syfonami',
                   'Pomiędzy Świętami a Nowym Rokiem w składzie Łukasz Drozd, Mirek Kopertowski (obaj SGW) oraz Michał Plata (KKS) udaliśmy się na biwak do Śnieżnej. Głównym celem tego biwaku było dokonanie rekonesansu za syfonami (Dziadka i Beaty) i przygotowanie do nurkowania w jeziorku X. Podczas akcji dotarłem do jeziorka X wymieniając po drodze oporęczowanie na VI i VII wodospadzie. Z uwagi na brak czasu nurkowanie w samym jeziorku zostało odłożone do następnej akcji. (wkrótce relacja)',
                   '','',
                   '13. Styczeń 2007','Mirek Kopertowski');
  ...
  ExtendedListItem('X divers team w Miltitz',
                   ...
                   $dir.'/swiat/publication.php?id=2006miltitz','RELACJA Z WYJAZDU',
...
StartList();
  ...
  ExtendedListItem('Trening RNJ w kamieniołomie Zakrzówek',
                   ...
                   $dir.'/ratownictwo/publication.php?id=2006zakrzowek2','RELACJA',
  ...
  ExtendedListItem('Trening RNJ w kamieniołomie Zakrzówek',
                   ...
                   $dir.'/ratownictwo/publication.php?id=2006zakrzowek','RELACJA',
  ...
  ExtendedListItem('Nurkowanie w „Winnicy”',
                   ...
                   $dir.'/polska/publication.php?id=winnica','RELACJA',
...
StartList();
  ...
  ExtendedListItem('Krym po raz 2-gi czyli wyprawa 2006',
                   ...
                   $dir.'/swiat/publication.php?id=2006krym','RELACJA Z WYJAZDU',
...
StartList();
  ExtendedListItem('Rumunia. Eksploracja wywierszyska Izbucul Galbenei',
                   ...
                   $dir.'/eksploracja/rumunia2006.php','RELACJA Z WYJAZDU',
...
StartList();
  ExtendedListItem('X divers team we Włoszech',
                   'W czasie tzw. długiego czerwcowego weekendu znów byliśmy w
                    ...
                    Oliero',
                   $dir.'/swiat/wlochy_czerwiec06.php','RELACJA Z WYJAZDU',
  ...
  ExtendedListItem('Warsztaty Nurkowania Jaskiniowego - Etap 2 - SŁOWENIA',
                   ...
                   $dir.'/warsztaty/opis06.php','PODSUMOWANIE WARSZTATÓW',
                   '18. Czerwiec 2006',
                   'Mirek Kopertowski');
...
StartList();
  ...
  ExtendedListItem('Góry Izerskie',
                   '19. Marca odbył się rozpoznawczo-treningowy wyjazd w 
                    ...
                    <a class="navi" href="'.$dir.'/polska/dreibruder01.php">Drei Bruder</a>.
                    W wyjeździe uczestniczyli: Dominik Graczyk "Honzo", 
